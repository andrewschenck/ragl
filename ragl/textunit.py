...
#         """
#         Validate the tags attribute.
#
#         Ensures that tags is a list of strings if provided.
#
#         Raises:
#             ValidationError:
...
#
#         Ensures that the text is a non-empty string.
#
#         Raises:
#             ValidationError:
#                 If the text is empty or not a string.
#         """
...
#             msg = 'TextUnit.text cannot be whitespace-only or zero-length'
#             _LOG.error(msg)
#             raise ValidationError(msg)
#
...
#
#         Ensures that timestamp is a positive integer.
#
#         Raises:
#             ValidationError:
#                 If timestamp is not a positive integer.
#         """
...
#         """
#         Validate the distance attribute.
#
#         Ensures that distance is a float between 0.0 and 1.0.
#
#         Raises:
#             ValidationError:
#                 If distance is not within the valid range.
#         """
#         if not isinstance(self.distance, float):
#             msg = 'Distance must be a float'
#             _LOG.error(msg)
#             raise ValidationError(msg)
#         if not 0.0 <= self.distance <= 1.0:
#             msg = 'Distance must be 0.0 and 1.0'
#             _LOG.error(msg)
#             raise ValidationError(msg)
#
...
#
#         Validates the text content after instance creation.
#         """
#         self._validate_tags()
#         self._validate_text()
